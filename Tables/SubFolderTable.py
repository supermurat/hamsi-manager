...
class SubFolderTable():
    ...
    def _subShowDetails(self, _fileNo, _infoNo):
        TextDetails.TextDetails(InputOutputs.IA.currentDirectoryPath+"/"+SubFolders.currentFilesAndFoldersValues[_fileNo][1],self.isOpenDetailsOnNewWindow.isChecked())
    ...
    def _subTableCellDoubleClicked(self,_row,_column):
        try:
            ...
            Dialogs.showError(translate("SubFolderTable", "Cannot Open File"), 
                        ...
                        ) % Organizer.getLink(InputOutputs.IA.currentDirectoryPath+"/"+SubFolders.currentFilesAndFoldersValues[_row][1]))
