...
class QuickOptions(MMenu):
    def __init__(self, _parent=None):
        ...
        self.keysOfSettings = ["isActiveClearGeneral", "isClearEmptyDirectoriesWhenSave",
        ...
        self.toolTips = [translate("QuickOptions", "Are you want to activate General Cleaner?"),
                         ...
                         translate("QuickOptions",
                                   "File names will be changed automatically to the format you selected."),
                         translate("QuickOptions",
                                   "Directory names will be changed automatically to the format you selected."),
                         translate("QuickOptions",
                                   "File extensions will be changed automatically to the format you selected."),
                         ...
                         translate("Options/HiddenObjects",
                                   "Are you want to show hidden files and directories in subfolder table?"),
                         translate("Options/HiddenObjects",
                                   "Are you want to show hidden files and directories in folder table?"),
