...
class AmarokMusicOptionsBar(MToolBar):
    ...
    def getSpecialOptions(self, _menu):
        ...
        wactSourceLabel.setDefaultWidget(MLabel(str(translate("AmarokMusicOptionsBar", "Read From : "))))
        wactTargetLabel = MWidgetAction(_menu)
        wactTargetLabel.setDefaultWidget(MLabel(str(translate("AmarokMusicOptionsBar", "Write To : "))))
