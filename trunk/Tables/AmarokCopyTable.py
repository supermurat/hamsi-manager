                ...
                try:
                    if self.Table.isRowHidden(rowNo) == False:
                        ...
                        newFilePath = fu.getRealPath(
                            fu.joinPath(str(self.Table.SubTable.leDestinationDirPath.text()), baseNameOfDirectory,
                                        baseName))
                        if fu.isFile(self.Table.currentTableContentValues[rowNo]["path"]) and fu.isReadableFileOrDir(
                            self.Table.currentTableContentValues[rowNo]["path"], False, True):
                            if fu.isWritableFileOrDir(newFilePath, False, True):
                                newFilePathCopied = fu.copyOrChange(self.Table.currentTableContentValues[rowNo]["path"],
                                                                    newFilePath)
                                    ...
                                    try:
                                        ...
                                        if self.Table.isChangeableItem(rowNo, 2):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Artist")),
                                                        str(self.Table.currentTableContentValues[rowNo]["artist"]),
                                                        value)
                                            self.Table.changedValueNumber += 1
                                        if self.Table.isChangeableItem(rowNo, 3):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Title")),
                                                        str(self.Table.currentTableContentValues[rowNo]["title"]),
                                                        value)
                                            self.Table.changedValueNumber += 1
                                        if self.Table.isChangeableItem(rowNo, 4):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Album")),
                                                        str(self.Table.currentTableContentValues[rowNo]["album"]),
                                                        value)
                                            self.Table.changedValueNumber += 1
                                        if self.Table.isChangeableItem(rowNo, 5):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Track No")),
                                                        str(self.Table.currentTableContentValues[rowNo]["trackNum"]),
                                                        value)
                                            self.Table.changedValueNumber += 1
                                        ...
                                        if self.Table.isChangeableItem(rowNo, 7):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Genre")),
                                                        str(self.Table.currentTableContentValues[rowNo]["genre"]),
                                                        value)
                                            self.Table.changedValueNumber += 1
                                        if self.Table.isChangeableItem(rowNo, 8):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Comment")), str(
                                                self.Table.currentTableContentValues[rowNo]["firstComment"]), value)
                                            self.Table.changedValueNumber += 1
                                        if len(self.Table.tableColumns) > 9 and self.Table.isChangeableItem(rowNo, 9):
                                            ...
                                            Records.add(str(translate("AmarokCopyTable", "Lyrics")),
                                                        str(self.Table.currentTableContentValues[rowNo]["firstLyrics"]),
                                                        value)
                                            self.Table.changedValueNumber += 1
                                        tagger.update()
                                    except:
