...
class CoverOptionsBar(MToolBar):
    ...
    def getSpecialOptions(self, _menu):
        ...
        wactLabel.setObjectName(str(translate("CoverOptionsBar", "Label Deep") + " : "))
        wactLabel.setDefaultWidget(MLabel(str(translate("CoverOptionsBar", "Deep") + " : ")))
        wact = MWidgetAction(_menu)
        wact.setObjectName(str(translate("CoverOptionsBar", "Deep") + " : "))
