...
def installThisPlugin():
    ...
    iconPath =  InputOutputs.joinPath(Universals.themePath, "Images", "HamsiManager-32x32-1.ico")
    
    actionsValues = [{"object": "*",
                        "key": "HamsiManager", 
                        "title": "Hamsi Manager", 
                        "icon": InputOutputs.joinPath(Universals.themePath, "Images", "HamsiManager-32x32-1.ico"), 
