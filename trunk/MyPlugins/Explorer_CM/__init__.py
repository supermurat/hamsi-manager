...
def installThisPlugin():
    ...
    iconPath =  InputOutputs.joinPath(InputOutputs.themePath, "Images", "HamsiManager-16x16-1.ico")
                    ...
                    {"object": "Directory",
                        ...
                        "actions": [{"key": "copyPath", 
                                    ...
                                    {"key": "emendDirectory", 
                                            ...
                                            "icon": InputOutputs.joinPath(InputOutputs.themePath, "Images", "emendDirectory.ico"), 
                                    ...
                                    {"key": "emendDirectoryWithContents", 
                                            ...
                                            "icon": InputOutputs.joinPath(InputOutputs.themePath, "Images", "emendDirectoryWithContents.ico"), 
                                            "command" : executeCommandOfHamsiManager + " --qm --emendDirectoryWithContents \"%1\""}, 
                                    {"key": "pack", 
                                            "title": translate("MyPlugins/Explorer_CM", "Pack It"), 
                                            "icon": InputOutputs.joinPath(InputOutputs.themePath, "Images", "pack.ico"), 
                                            "command" : executeCommandOfHamsiManager + " --qm --pack \"%1\""}, 
                                    {"key": "checkIcon", 
                                            "title": translate("MyPlugins/Explorer_CM", "Check Directory Icon"), 
                                            "icon": InputOutputs.joinPath(InputOutputs.themePath, "Images", "checkIcon.ico"), 
                                    ...
                                    {"key": "removeOnlySubFiles", 
                                            ...
                                            "icon": InputOutputs.joinPath(InputOutputs.themePath, "Images", "removeOnlySubFiles.ico"), 
                                            "command" : executeCommandOfHamsiManager + " --qm --removeOnlySubFiles \"%1\""}, 
                                    {"key": "clear", 
                                            "title": translate("MyPlugins/Explorer_CM", "Clear It"), 
                                            "icon": InputOutputs.joinPath(InputOutputs.themePath, "Images", "clear.ico"), 
